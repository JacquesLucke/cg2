...
\newcommand{\finishingdate}{11.05.2018}
\newcommand{\titletext}{Blatt 1} %TODO: Nummer anpassen
...
\author{
	\vspace{3.5cm}\\
	\begin{tabular}{rl}
          \textbf{Mat.-Nr.} & \textbf{Mitglieder der
                              Gruppe ? }\\\hline\rule{0pt}{3ex}
          372322 & Johannes Huwald \\
	\end{tabular}
}
