/* test to use glfw and glad
   What glad is used for and how to get the machine compatible
   glad.c and glad.h... see:
   https://learnopengl.com/Getting-started/Creating-a-window
   
   tested from torstenschenk for opengl 4.5 on Ubuntu 16.04
*/
